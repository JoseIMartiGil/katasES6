...
console.log(rollDice(6));  // Simular un dado de 6 caras
console.log(rollDice(12)); // Simular un dado de 12 caras
console.log(rollDice(20)); // Simular un dado de 20 caras